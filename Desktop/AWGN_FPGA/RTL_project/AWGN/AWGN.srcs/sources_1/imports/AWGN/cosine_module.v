...
wire [18:0] D_pos,D_pos_p1;
wire [18:0] D_neg,D_neg_p1;
wire [6:0] p_1; 
wire [19:0] value_t;
wire [19:0] cos_pos;
wire [19:0] cos_neg;
wire [1:0] quadrand,quadrand_p2,quadrand_p3;
wire [13:0] x_pos,x_pos_p2;
wire [13:0] x_neg,x_neg_p2;
wire [18:0] c_0_pos_p1;
wire [18:0] c_0_neg_p1;

//internal registers
reg [16:0] value_d;
reg [18:0] cos_c_0[127:0];
reg [18:0] cos_c_1[127:0];
reg [18:0] c_0_pos,c_0_pos_d;
reg [18:0] c_1_pos;
reg [18:0] c_0_neg,c_0_neg_d;
reg [18:0] c_1_neg;
reg [1:0] quadrand_d,quadrand_d1;
reg [13:0] x_pos_d;
reg [13:0] x_neg_d;
reg [18:0] D_pos_d1;
reg [18:0] D_neg_d1;
...
//get outputs of dff level 2
assign quadrand_p3 = quadrand_d1;
assign D_neg_p1 = D_neg_d1;
assign D_pos_p1 = D_pos_d1;
assign c_0_neg_p1 = c_0_neg_d;
assign c_0_pos_p1 = c_0_pos_d;

//find cos value.
assign cos_neg = c_0_neg_p1 - D_neg_p1;
assign cos_pos = c_0_pos_p1 - D_pos_p1;
...
assign value_t = (quadrand_p3 == 2'b00)?cos_pos:( (quadrand_p3 == 2'b01)?(~cos_neg) +1:( (quadrand_p3 == 2'b10)?(~cos_pos) +1:cos_neg ) );

//get cosine of angle
assign value_p1 = value_t[19:3];

//get outputs of dff level 3

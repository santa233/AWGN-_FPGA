...
//internal registers
reg [16:0] cos_val_d1,cos_val_d2,cos_val_d3,cos_val_d4,cos_val_d5;
reg [16:0] cos_val_d6,cos_val_d7,cos_val_d8,cos_val_d9,cos_val_d10,cos_val_d11,cos_val_d12;
reg [31:0] urng0_s0;
reg [31:0] urng0_s1;
reg [31:0] urng0_s2;
reg [31:0] urng1_s0;
...
wire [32:0] temp_2;
wire [15:0] temp_3;
wire [16:0] cos_val,cos_val_p2,cos_val_p1,cos_val_p3,cos_val_p4,cos_val_p5;
wire [16:0] cos_val_p6,cos_val_p7,cos_val_p8,cos_val_p9,cos_val_p10,cos_val_p11,cos_val_p12;
wire [30:0] log_e_val;
wire [16:0] sqrt_val;
wire [47:0] u_0;
wire [15:0] u_1;
...
assign cos_val_p1 = cos_val_d1;
assign cos_val_p2 = cos_val_d2;
assign cos_val_p3 = cos_val_d3;
assign cos_val_p4 = cos_val_d4;
assign cos_val_p5 = cos_val_d5;
assign cos_val_p6 = cos_val_d6;
assign cos_val_p7 = cos_val_d7;
assign cos_val_p8 = cos_val_d8;
assign cos_val_p9 = cos_val_d9;
assign cos_val_p10 = cos_val_d10;
assign cos_val_p11 = cos_val_d11;
assign cos_val_p12 = cos_val_d12;

//multiplication of output square root module and signal from cos module d ff
assign temp_1 = (cos_val_p12[16] == 0)?cos_val_p12[15:0]:(~cos_val_p12[15:0])+1;
assign temp_2 = temp_1 * sqrt_val;
assign temp_3 = (cos_val_p12[16] == 0)?temp_2[32:17]:(~temp_2[32:17])+1;

/*assign temp_1 = (cos_val_p5[16] == 0)?cos_val_p5[15:0]:(~cos_val_p5[15:0])+1;
assign temp_2 = temp_1 * sqrt_val; 
assign temp_3 = (cos_val_p5[16] == 0)?temp_2[32:17]:(~temp_2[32:17])+1;
*/
...
//reset = 1? then initialize all registers
	if(reset != 1'b0)
	begin
		cos_val_d1 <= 17'h00000;
		cos_val_d2 <= 17'h00000;
		cos_val_d3 <= 17'h00000;
        cos_val_d4 <= 17'h00000;
        cos_val_d5 <= 17'h00000;
		cos_val_d6 <= 17'h00000;
        cos_val_d7 <= 17'h00000;
        cos_val_d8 <= 17'h00000;
        cos_val_d9 <= 17'h00000;
        cos_val_d10 <= 17'h00000;
        cos_val_d11 <= 17'h00000;
        cos_val_d12 <= 17'h00000;
...
//set value of cosine module d ff
		cos_val_d1 <= cos_val;
		cos_val_d2 <= cos_val_p1;
		cos_val_d3 <= cos_val_p2;
        cos_val_d4 <= cos_val_p3;
        cos_val_d5 <= cos_val_p4;
		cos_val_d6 <= cos_val_p5;
        cos_val_d7 <= cos_val_p6;
        cos_val_d8 <= cos_val_p7;
        cos_val_d9 <= cos_val_p8;
        cos_val_d10 <= cos_val_p9;
        cos_val_d11 <= cos_val_p10;
        cos_val_d12 <= cos_val_p11;
		case(state)

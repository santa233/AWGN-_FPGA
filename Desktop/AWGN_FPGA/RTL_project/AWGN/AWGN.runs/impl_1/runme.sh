...
HD_PWD='C:/Users/Santosh/Desktop/Xilinx Vivado Projects/AWGN/AWGN.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log AWGN.vdi -applog -m64 -messageDb vivado.pb -mode batch -source AWGN.tcl -notrace
